      ...
      <Dialog open={showManualOAuth} onOpenChange={setShowManualOAuth}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Connect your ChatGPT account to use with the dashboard
            </DialogDescription>
          </DialogHeader>

          <div className="space-y-4 py-4">
            {/* Step 1: Run the callback server */}
            <div className="rounded-lg bg-muted p-4 text-sm border border-border">
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="font-medium">Start the OAuth callback server</p>
              </div>
              <p className="text-muted-foreground mb-3 ml-8">
                OpenAI's OAuth requires a local server on port 1455. Run this command in a terminal:
              </p>
              <div className="ml-8 p-3 bg-background rounded-md border border-border">
                <code className="text-xs text-foreground">node scripts/oauth-callback-server.js</code>
              </div>
            ...
            <div className="rounded-lg bg-muted p-4 text-sm border border-border">
              ...
              <p className="text-muted-foreground mb-3 ml-8">
                After starting the server, click the button below to authorize:
              </p>
              <div className="ml-8">
                <Button onClick={() => {
                  ...
                  response.then(({ url }) => {
                    ...
                    setOAuthStatus({
                      status: 'error',
                      message: 'Failed to start OAuth flow. Is the dashboard running?',
                    });
                  });
                }} className="w-full">
            ...
            <details className="rounded-lg bg-muted p-4 text-sm border border-border">
              ...
              <div className="mt-3 space-y-2">
                ...
                <Button
                  ...
                  className="w-full"
                >
                  {isSubmittingManual ? 'Submitting...' : 'Submit Manual URL'}
                </Button>
              </div>
            </details>
